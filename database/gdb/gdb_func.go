...
import (
	...
	"github.com/dxasu/gf/internal/empty"
	"github.com/dxasu/gf/internal/json"
	"github.com/dxasu/gf/internal/utils"
	"github.com/dxasu/gf/os/gtime"
	"github.com/dxasu/gf/util/gmeta"
	"github.com/dxasu/gf/util/gutil"

	"github.com/dxasu/gf/internal/structs"
		...
		if value == nil || empty.IsNil(rv) {
			...
			if gstr.Pos(quotedKey, "?") == -1 {
				...
				if len(quotedKey) > len(like) && gstr.Equal(quotedKey[len(quotedKey)-len(like):], like) {
					...
					// Issue: https://github.com/dxasu/gf/issues/765
