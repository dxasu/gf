...
[![Go Doc](https://godoc.org/github.com/dxasu/gf?status.svg)](https://godoc.org/github.com/dxasu/gf)
[![Build Status](https://travis-ci.com/gogf/gf.svg?branch=master)](https://travis-ci.org/gogf/gf)
[![Go Report](https://goreportcard.com/badge/github.com/dxasu/gf?v=1)](https://goreportcard.com/report/github.com/dxasu/gf)
[![Code Coverage](https://codecov.io/gh/gogf/gf/branch/master/graph/badge.svg)](https://codecov.io/gh/gogf/gf/branch/master)
[![Production Ready](https://img.shields.io/badge/production-ready-blue.svg)](https://github.com/dxasu/gf)
[![License](https://img.shields.io/github/license/gogf/gf.svg?style=flat)](https://github.com/dxasu/gf)
...
# Installation
```
go get -u -v github.com/dxasu/gf
```
suggested using `go.mod`:
```
require github.com/dxasu/gf latest
```
...
* GoDoc API: https://godoc.org/github.com/dxasu/gf
...
# Contributors
This project exists thanks to all the people who contribute. [[Contributors](https://github.com/dxasu/gf/graphs/contributors)].
<a href="https://github.com/dxasu/gf/graphs/contributors"><img src="https://opencollective.com/goframe/contributors.svg?width=890&button=false" /></a>
